...
function sections:CreateLabel(Properties)
	...
	library.CurrentWindow = self.Window
	local Content = {
		Name = utility:Resolve(Properties, {"name", "Name", "title", "Title"}, "Label"),
		Text = utility:Resolve(Properties, {"text", "Text", "desc", "Desc", "description", "Description"}, nil),
		Color = utility:Resolve(Properties, {"color", "Color"}, nil),
		Window = self.Window,
		Page = self.Page,
		Section = self
	}
	...
	if Content.Color == nil then
		Content.Color = self.Window.Accent
	end
	local Content_Holder = utility:RenderObject("Frame", {
		BackgroundColor3 = Color3.fromRGB(0, 0, 0),
		BackgroundTransparency = 1,
	...
	local LabelObject = utility:RenderObject("TextLabel", {
		AnchorPoint = Vector2.new(0, 0),
		BackgroundColor3 = Color3.fromRGB(0, 0, 0),
		BackgroundTransparency = 1,
		BorderColor3 = Color3.fromRGB(0, 0, 0),
